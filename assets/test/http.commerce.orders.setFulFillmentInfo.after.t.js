...
var actionName = 'http.commerce.orders.setFulFillmentInfo.after';

describe('http.commerce.orders.setFulFillmentInfo.after implementing http.commerce.orders.setFulFillmentInfo.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.orders/http.commerce.orders.setFulFillmentInfo.after');
  });
